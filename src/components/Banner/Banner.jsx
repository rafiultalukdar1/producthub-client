            ...
            <div className="py-[90px] lg:py-[145px] bg-linear-to-r from-[#038b3e] to-[#2bad64]">
                <div className='container'>
                    ...
                    <div className='flex flex-col sm:flex-row justify-center gap-2.5 sm:gap-5 mt-8'>
                        <button className='bg-[#2694c0] text-white px-6 py-3 rounded-lg font-medium flex items-center gap-2 hover:bg-[#1b83ac] transition justify-center cursor-pointer'><span>Browse Products</span> <ArrowRight /></button>
                        <button className='border border-white text-white bg-[#ffffff2f] px-6 py-3 rounded-lg hover:bg-white hover:text-[#219E64] transition font-medium cursor-pointer'>Add Your Product</button>
                    </div>
                </div>
            </div>
        </>
