                    ...
                    <div className='max-w-[510px] mx-auto px-[25px] py-7 md:py-10 md:px-10 bg-white shadow-xl rounded-md border border-[#e7e7e798]'>
                        ...
                        <form onSubmit={handleRegister}>
                            <fieldset className="fieldset">
                                ...
                                {/* Button */}
                                <button type="submit" className='py-2 w-full bg-[#E15C43] rounded mt-5 text-white text-[18px] font-medium cursor-pointer'>Register</button>
                            </fieldset>
                        </form>
                        ...
                        <p className='text-center text-[#464545] text-[16px] font-medium pt-[22px]'>Already have an account? <Link href="/login" className='text-[#E15C43] font-semibold' to='/login'>Login</Link></p>
                    </div>
                </div>
            </div>
        </>
